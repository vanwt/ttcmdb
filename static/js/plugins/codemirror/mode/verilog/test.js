...
(function() {
  ...
  MT("export_task_one_line_does_not_indent",
     "[keyword export] [string \"DPI-C\"] [keyword plan] [variable helloFromSV];",
     ""
  );
  ...
  MT("export_task_two_lines_indents_properly",
    "[keyword export]",
    "    [string \"DPI-C\"] [keyword plan] [variable helloFromSV];",
    ""
  );
  ...
  MT("import_task_one_line_does_not_indent",
    "[keyword import] [string \"DPI-C\"] [keyword plan] [variable helloFromC];",
    ""
  );
